...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO ETZ", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W5k3f3cUVHL4UkJiJkjhZomy3F224vX8Cx")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "W5k3f3cUVHL4UkJiJkjhZomy3F224vX8Cx"
	account := &openwallet.AssetsAccount{Alias: "mainnetTRUEH", WalletID: walletID, Required: 1, Symbol: "ETZ", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "W5k3f3cUVHL4UkJiJkjhZomy3F224vX8Cx"
	accountID := "BGuDuzbCLU6WAYwuVj3E3kkUY9tZLpAVQ8G9oWNWyxG1"
